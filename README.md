...
[**CC BY-NC-SA 4.0**](./LICENSE) — Creative Commons 署名-非商业-相同方式共享

| 你能做 | 必须遵守 |
|--------|---------|
| ✅ 个人阅读、学习、研究、做笔记 | 注明来源 |
| ✅ 节选转载到博客 / 公众号 / 知乎 / B 站 | 注明来源 |
| ✅ 二次创作（讲解视频 / 派生教程） | 注明来源 + 派生作品同样开源 |
| ❌ 印刷出版纸质书牟利 | 必须先获得授权 |
| ❌ 打包进付费课程 / 付费 workshop | 必须先获得授权 |
| ❌ 作为企业内训的主要教材 | 必须先获得授权 |
| ❌ 作为客户交付物的主要内容 | 必须先获得授权 |

详细中文解读见 [LICENSE.zh-CN.md](./LICENSE.zh-CN.md)。
